...
int main()
{
    ...
    QuestDAO questDao(connection);
    assert(questDao.createQuest(QuestRecord{
        .questName = "Smoke Quest",
        .description = "DAO smoke test quest.",
        .rewardGold = 5,
        .rewardExperience = 10,
    }));
    assert(questDao.assignQuest(CharacterQuestRecord{
        .characterId = 1,
        .questId = 1,
        .progress = 0,
        .status = "not_started",
