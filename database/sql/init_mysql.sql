...
CREATE TABLE IF NOT EXISTS characters (
    ...
    hair_color VARCHAR(32) NOT NULL DEFAULT '',
    eye_color VARCHAR(32) NOT NULL DEFAULT '',
    blood_status ENUM('pureblood', 'halfblood', 'muggleborn') NOT NULL DEFAULT 'halfblood',
...
CREATE TABLE IF NOT EXISTS player_locations (
    ...
    PRIMARY KEY (character_id),
    KEY idx_player_locations_room_id (room_id),
    KEY idx_player_locations_is_online (is_online),
    CONSTRAINT fk_player_locations_character_id
        FOREIGN KEY (character_id) REFERENCES characters(character_id)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_player_locations_room_id
        FOREIGN KEY (room_id) REFERENCES rooms(room_id)
        ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
