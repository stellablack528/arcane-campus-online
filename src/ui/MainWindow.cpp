...
void MainWindow::connectWidgetSignals()
{
    ...
    connect(m_actionBar, &LocationActionBar::studyRequested,
            this, &MainWindow::studyRequested);
    connect(m_actionBar, &LocationActionBar::joinActivityRequested,
            this, &MainWindow::activityJoinRequested);
    connect(m_memberList, &MemberListWidget::memberSelected,
            this, &MainWindow::memberSelected);
    connect(m_memberList, &MemberListWidget::privateChatRequested,
